...
p;18;CPPlatformWindow.jI;21;Foundation/CPObject.jc;4119;
var _1=NULL;
...
}),new objj_method(sel_getUid("setShadowStyle:"),function(_29,_2a,_2b){
with(_29){
_shadowStyle=_2b;
if(_DOMWindow&&_DOMWindow.cpSetShadowStyle){
_shadowStyle.cpSetShadowStyle(_2b);
}
}
}),new objj_method(sel_getUid("supportsFullPlatformWindows"),function(_2c,_2d){
with(_2c){
return objj_msgSend(CPPlatform,"isBrowser");
}
})]);
class_addMethods(_3,[new objj_method(sel_getUid("primaryPlatformWindow"),function(_2e,_2f){
with(_2e){
return _1;
}
}),new objj_method(sel_getUid("setPrimaryPlatformWindow:"),function(_30,_31,_32){
with(_30){
_1=_32;
}
})]);
...
p;10;CPWindow.jI;25;Foundation/CPCountedSet.jI;33;Foundation/CPNotificationCenter.jI;26;Foundation/CPUndoManager.ji;12;CGGeometry.ji;13;CPAnimation.ji;13;CPResponder.ji;10;CPScreen.ji;18;CPPlatformWindow.jc;46799;
